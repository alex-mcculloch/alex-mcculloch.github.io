...
student %>%
  ...
  ggplot(aes(x = dropout_rate, y = reorder(as.factor(Course), dropout_rate), fill = highlight)) +
  geom_col() +
  scale_fill_manual(values = c("FALSE" = "grey80", "TRUE" = "#e74c3c"), guide = "none") +
  labs(title = "8 in 10 Students Enrolled in Program 9119 <span style='color:#e74c3c;'>Fail to Graduate</span>",
       subtitle = "Dropout rate by program",
       caption = "Realinho, Valentim, Mónica Vieira Martins, Jorge Machado, and Luís Baptista. 2021.\nPredict Students' Dropout and Academic Success.\nUCI Machine Learning Repository. https://doi.org/10.24432/C5MC89.",
       x = "Dropout Rate (%)",
       y = "Program") +
   theme_minimal() +
