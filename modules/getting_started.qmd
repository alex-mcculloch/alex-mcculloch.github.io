...
Tip: create a field in your system that identifies all fields that may fall under the above categories. Systems such as Salesforce allows you to specify the level of sensitivity for any field you create.
